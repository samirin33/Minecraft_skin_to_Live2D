...
サムネイル等で使用するためにポージングさせたい場合に腕をある程度任意の角度で固定することができます。  
...
Youtubeの概要欄等のユーザーの目に届く場所に「samirin33」の名前、又は「[https://x.com/samirin33](https://x.com/samirin33)」のリンクを記載してください。(義務)
